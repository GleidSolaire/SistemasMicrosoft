...
namespace GerenciamentoFuncionarios.Controllers
{
    ...
    {
        private readonly GerenciamentoFuncionariosContext _context;

        public DepartamentosController(GerenciamentoFuncionariosContext context)
        {
            _context = context;
        }
        ...
        {
            var gerenciamentoFuncionariosContext = _context.Departamento.Include(d => d.Responsavel);
            return View(await gerenciamentoFuncionariosContext.ToListAsync());
        }
